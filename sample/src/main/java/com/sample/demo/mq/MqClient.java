...
public class MqClient {
    ...
    public synchronized boolean connect(){
        ...
        String userName = "A1BF2BEB9BAD2F3AFAB083A237AE570E0"; //MQID

        String mqTopic = "test"; //mq topic
        String mqSub = "read"; // mq sub
            try {
                if(null == client) {
    ...
    private void resetOptions(){
        String userName = "A1BF2BEB9BAD2F3AFAB083A237AE570E0"; //MQID
        String accessKey = "/eWHWnyN90xLjh6X53beASCYaCWS2oXHXCZWizv85ds="; //mq access_key
